...
## Steps
- [ ] Establish shared audio format constants for JS, document AVFoundation support, and use them for drag/drop + dialog defaults.
- [ ] Update JS library ingestion (LocalMusicState, playlist drop/import) to rely on shared formats and avoid mp3-only parsing.
