...
const DEBUG_AI_LOGS_DEFAULT = false;
...
const DEBUG_SPOTIFY_LOGS_DEFAULT = false;
const DEBUG_YOUTUBE_MUSIC_LOGS_DEFAULT = false;

export const DEBUG_AI_LOGS = DEBUG_ALL || DEBUG_AI_LOGS_DEFAULT;
...
export const DEBUG_SPOTIFY_LOGS = DEBUG_ALL || DEBUG_SPOTIFY_LOGS_DEFAULT;
export const DEBUG_YOUTUBE_MUSIC_LOGS = DEBUG_ALL || DEBUG_YOUTUBE_MUSIC_LOGS_DEFAULT;
